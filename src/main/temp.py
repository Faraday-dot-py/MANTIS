...
# model = tf.keras.models.load_model(r'C:\Users\awebb\Documents\Programming\Python\MANTIS\models\direction_predictor.keras')

# Initialize the TemporalMap object
tmapMaker = TemporalMap(RENDER_TMAPS=False, MODEL_PATH=r'C:\Users\awebb\Documents\Programming\Python\MANTIS\models\hand_landmarker.task')
tmapMaker.setup()
