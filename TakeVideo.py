...
if not os.path.exists(f'captured_images/{l2r_or_r2l}'):
    os.makedirs(f'captured_images/{l2r_or_r2l}')
...
while True:
    ...
    if spacePressed and not wasPressed:
        ...
        captureSequenceFolder = f'captured_images/{l2r_or_r2l}/capture_{len(os.listdir(f"captured_images/{l2r_or_r2l}"))}'
